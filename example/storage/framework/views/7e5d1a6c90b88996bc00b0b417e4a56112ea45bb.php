        ...
        <div class="container position-relative">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-5">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-dark btn-lg brak">Dołącz do nas</a>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ZeroWaste\zeroWaste\example\resources\views/pages/about.blade.php ENDPATH**/ ?>